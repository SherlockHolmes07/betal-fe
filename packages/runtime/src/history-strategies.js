/**
 * The 4 URL behaviors that differ between a hash-based and a real
 ...
 * `getCurrentPath` and prepend it in `pushPath`/`linkHref`; `Router` only
 * ever calls these 4 methods, so that extension wouldn't touch it at all.
 *
 * @type {HistoryStrategy}
 */
